...
Redux::set_section($opt_name, $aSection);
...
$aSection = array(
	...
	'fields'     => array(
		...
		array(
			'id'    => 'opt-slides',
			'type'  => 'slides',
			'title' => __('Slides Options', 'quandoan-theme-options'),
			'show'  => array(
				'media' => false,
				'title'       => true,
				'description' => false,
			...
			'subtitle' => __('Unlimited slides with drag and drop sortings.', 'quandoan-theme-options'),
			'desc'     => __('This field will store all slides values into a multidimensional array to use into a foreach loop.', 'quandoan-theme-options'),
			'placeholder' => array(
				'title'       => __('Social Media', 'quandoan-theme-options'),
				'description' => __('Description Here', 'quandoan-theme-options'),
				'url'         => __('Give us a link!', 'quandoan-theme-options'),
			),
		),
	)
);
